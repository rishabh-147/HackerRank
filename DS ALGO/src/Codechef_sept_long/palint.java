...
public class palint {
	...
	public static void main(String[] args) {
		...
		// create two maps, in the first one insert the occurance of the values in given
		// array, in the second map, store the number of times a value occured while XOR
		// with N.
		// print the maximum number of occurances and the number of XORs used (the value
		// stored in 2nd map.)
		...
		//	System.out.println(mapA.entrySet() + "\n\n\n");
			...
			//merge both the maps to A incrementing the values of the pre-existing keys accordingly;
